...
function MessagesPage() {
  ...
  return (
    <div className={`${isFullPageChat ? 'fixed inset-0 z-50 bg-white dark:bg-gray-900' : 'min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900'}`}>
      <div className={`${isFullPageChat ? 'h-full' : 'max-w-6xl mx-auto h-[calc(100vh-12rem)] max-h-[calc(100vh-12rem)]'} flex flex-col ${isFullPageChat ? 'p-0' : 'm-4'}`}>
        ...
        <div className="flex flex-1 min-h-0">
          {/* Conversations List */}
          <div className={`${adsConfig?.messengerAd?.active ? 'w-1/4' : 'w-1/3'} border-r border-gray-200/30 dark:border-gray-700/30 flex flex-col`}>
