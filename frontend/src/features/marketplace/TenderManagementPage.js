...
function TenderManagementPage({ showBuyTabOnly = false, showSellTabOnly = false }) {
  ...
  const fetchTendersOverview = React.useCallback(async () => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        console.error('Failed to fetch tenders overview');
        setTendersOverview([]);
      }
    } catch (error) {
  ...
  return (
    <div className="space-y-8">
      ...
      {/* Tab Navigation - Hidden when showing only one tab */}
      {!showBuyTabOnly && !showSellTabOnly && (
          ...
          <div className="bg-white dark:bg-gray-800 rounded-xl p-4 sm:p-6 border border-gray-200 dark:border-gray-700">
            <div className="flex items-center">
              ...
              <div className="ml-3 sm:ml-4 min-w-0 flex-1">
                <h3 className="text-xs sm:text-sm font-medium text-gray-600 dark:text-gray-400 truncate">Active Listings</h3>
                <p className="text-xl sm:text-2xl font-bold text-gray-900 dark:text-white">{tendersOverview.length}</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-xl p-4 sm:p-6 border border-gray-200 dark:border-gray-700">
            <div className="flex items-center">
              ...
              <div className="ml-3 sm:ml-4 min-w-0 flex-1">
                ...
                <p className="text-xl sm:text-2xl font-bold text-gray-900 dark:text-white">{totalTenders}</p>
              </div>
            </div>
          </div>
...
// Simple MyListingCard Component
