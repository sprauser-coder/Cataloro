            ...
            <div className="space-y-6">
              ...
              <div className="flex items-center space-x-3">
                <input
                  ...
                  className="w-5 h-5 text-purple-600 bg-white border-gray-400 rounded focus:ring-purple-500 dark:focus:ring-purple-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"
                />
