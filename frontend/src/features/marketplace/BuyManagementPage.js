...
function BuyManagementPage() {
  ...
  const assignItemToBasket = async (itemId, basketId) => {
    console.log('assignItemToBasket function called with:', { itemId, basketId });
        ...
        <div className="relative z-50">
          <button
            onClick={(e) => {
              e.preventDefault();
              e.stopPropagation();
              console.log('Assignment button clicked for item:', item.id);
              ...
              <div className="py-1">
                ...
                <button
                  onClick={(e) => {
                    e.preventDefault();
                    e.stopPropagation();
                    console.log('Creating new basket from dropdown');
                    onCreateBasket();
                    setShowAssignMenu(false);
                  }}
