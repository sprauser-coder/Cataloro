...
function BasketsTab({ baskets, onCreateBasket, onEditBasket, onDeleteBasket, onUnassignFromBasket, onReassignToBasket, onExportBasketsPDF, exportingBaskets, calculateTotals, loading }) {
  return (
    <div className="space-y-6">
