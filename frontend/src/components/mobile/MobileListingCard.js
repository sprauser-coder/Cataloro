                      ...
                      <div className="flex items-center space-x-2">
                        ...
                        <div>
                          ...
                          <div className="text-sm font-bold text-indigo-900 dark:text-indigo-100 leading-tight">
                            {formatEuro(priceSuggestion * (100 - priceRangeSettings.price_range_min_percent) / 100)} - {formatEuro(priceSuggestion * (100 + priceRangeSettings.price_range_max_percent) / 100)}
                          </div>
                        </div>
                      </div>
                    </div>
