      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {favorites.length === 0 ? (
          <div className="text-center py-12">
            ...
            <p className="mt-1 text-sm text-gray-500">Start browsing and save items you like!</p>
            <div className="mt-6">
            ...
            {favorites.map((favorite) => (
              <Card key={favorite.id} className="overflow-hidden">
                <div className="aspect-w-1 aspect-h-1">
                  <img
                    src={favorite.listing.image_url || '/api/placeholder/300/300'}
                    alt={favorite.listing.title}
                    className="w-full h-48 object-cover"
                  />
                </div>
                <CardContent className="p-4">
                  <h3 className="font-semibold text-lg mb-2 line-clamp-2">{favorite.listing.title}</h3>
                  ...
                  <div className="flex justify-between items-center">
                    <Button
                      size="sm"
                      onClick={() => window.location.href = `/?id=${favorite.listing.id}`}
                    >
                      View Details
                    </Button>
                    <Button
