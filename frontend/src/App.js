...
console.log('🎯 LOADING CATALORO FULL MARKETPLACE INTERFACE - 7644 LINES - 2025-08-25');
...
const ListingDetail = () => {
  ...
  const handleBuyNow = async () => {
    try {
      await axios.post(`${API}/orders`, {
        listing_id: id,
        quantity: 1,
        total_amount: listing.current_price || listing.price
      });
      toast({
        title: "Success",
  ...
  const handlePlaceBid = async () => {
    if (!bidAmount || parseFloat(bidAmount) <= (listing.current_bid || listing.starting_price)) {
      toast({
        title: "Invalid bid",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="bg-white rounded-lg shadow-lg overflow-hidden">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 p-8">
            ...
            <div>
              <img
                src={getImageUrl(listing.image_url) || '/api/placeholder/600/400'}
                alt={listing.title}
                className="w-full h-96 object-cover rounded-lg"
              />
            </div>
                ...
                {listing.listing_type === 'auction' ? (
                  <div>
                    <div className="text-3xl font-bold text-green-600 mb-2">
                      Current Bid: €{listing.current_bid || listing.starting_price}
                    </div>
                    ...
                    <div className="flex space-x-2">
                      <Input
                        ...
                        className="flex-1"
                      />
                      <Button onClick={handlePlaceBid} className="bg-orange-600 hover:bg-orange-700">
                        Place Bid
                      </Button>
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <Button onClick={handleBuyNow} className="w-full bg-indigo-600 hover:bg-indigo-700 mb-4">
                      Buy Now
                    </Button>
                  </div>
                )}
              ...
              <div className="border-t pt-6">
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">Member since {new Date(listing.seller?.created_at).getFullYear()}</p>
                  </div>
                </div>
              </div>
