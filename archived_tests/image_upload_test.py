...
class ImageUploadTester:
    ...
    async def test_cors_preflight(self) -> Dict:
        ...
        cors_headers = {
            "Origin": "https://mobilefixed-market.preview.emergentagent.com",
        ...
        cors_working = (
            ...
            cors_analysis["access_control_allow_origin"] in ["*", "https://mobilefixed-market.preview.emergentagent.com"]
        )
