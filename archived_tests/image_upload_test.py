...
class ImageUploadTester:
    ...
    async def test_cors_preflight(self) -> Dict:
        ...
        cors_headers = {
            "Origin": "https://cataloro-admin-fix.preview.emergentagent.com",
        ...
        cors_working = (
            ...
            cors_analysis["access_control_allow_origin"] in ["*", "https://cataloro-admin-fix.preview.emergentagent.com"]
        )
