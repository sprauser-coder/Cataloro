  ...
  return (
    <div className="space-y-8">
      ...
      {activeTab === 'listings' ? (
        ...
        // Tenders Tab Content (previously My Tenders)
        <div className="space-y-6">
          {/* Statistics */}
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl p-6 border border-gray-200 dark:border-gray-700">
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  ...
                  <p className="text-2xl font-bold text-gray-900 dark:text-white">{rejectedTenders.length}</p>
                </div>
              </div>
            </div>
          </div>
          ...
          {loadingMyTenders ? (
            <div className="bg-white dark:bg-gray-800 rounded-xl p-12 border border-gray-200 dark:border-gray-700 text-center">
              ...
              <p className="text-gray-600 dark:text-gray-300">Loading your tenders...</p>
            </div>
          ) : myTenders.length === 0 ? (
            <div className="bg-white dark:bg-gray-800 rounded-xl p-12 border border-gray-200 dark:border-gray-700 text-center">
              <TrendingUp className="w-12 h-12 text-gray-400 mx-auto mb-4" />
              <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-2">No tenders yet</h3>
              <p className="text-gray-600 dark:text-gray-300">Make offers on listings to see them here</p>
              <Link 
                to="/browse" 
            ...
            <div className="space-y-4">
              {myTenders.map((tender) => (
                <div key={tender.id} className="bg-white dark:bg-gray-800 rounded-xl p-6 border border-gray-200 dark:border-gray-700">
                  <div className="flex items-start space-x-4">
                    {/* Listing Image */}
        ...
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            <div className="bg-white dark:bg-gray-800 rounded-xl p-6 border border-gray-200 dark:border-gray-700">
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  <h3 className="text-sm font-medium text-gray-600 dark:text-gray-400">Total Sold</h3>
                  <p className="text-2xl font-bold text-gray-900 dark:text-white">{soldItemsStats.totalSold}</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl p-6 border border-gray-200 dark:border-gray-700">
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  ...
                  <p className="text-2xl font-bold text-gray-900 dark:text-white">€{soldItemsStats.totalRevenue?.toFixed(2) || '0.00'}</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl p-6 border border-gray-200 dark:border-gray-700">
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  ...
                  <p className="text-2xl font-bold text-gray-900 dark:text-white">€{soldItemsStats.averagePrice?.toFixed(2) || '0.00'}</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl p-6 border border-gray-200 dark:border-gray-700">
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  ...
                  <p className="text-2xl font-bold text-gray-900 dark:text-white">{soldItemsStats.thisMonth}</p>
                </div>
              </div>
            </div>
          </div>
          ...
          {loadingSoldItems ? (
            <div className="bg-white dark:bg-gray-800 rounded-xl p-12 border border-gray-200 dark:border-gray-700 text-center">
              <div className="w-8 h-8 border-4 border-blue-600 border-t-transparent rounded-full animate-spin mx-auto mb-4"></div>
              <p className="text-gray-600 dark:text-gray-300">Loading sold items...</p>
            </div>
          ) : soldItems.length === 0 ? (
            <div className="bg-white dark:bg-gray-800 rounded-xl p-12 border border-gray-200 dark:border-gray-700 text-center">
              <Package className="w-12 h-12 text-gray-400 mx-auto mb-4" />
              <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-2">No sold items yet</h3>
              <p className="text-gray-600 dark:text-gray-300">Items you've sold will appear here</p>
              <Link 
                to="/create-listing" 
                className="mt-4 inline-flex items-center px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white rounded-lg font-medium transition-colors"
              >
            ...
            <div className="space-y-4">
              {soldItems.map((item) => (
                <div key={item.id} className="bg-white dark:bg-gray-800 rounded-xl p-6 border border-gray-200 dark:border-gray-700">
                  <div className="flex items-start space-x-4">
                    {/* Item Image */}
                    <div className="w-20 h-20 flex-shrink-0">
                      <img
                        src={item.listing?.images?.[0] || '/api/placeholder/400/300'}
                        alt={item.listing?.title || 'Sold item'}
                        className="w-full h-full object-cover rounded-lg"
                      />
                    </div>
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-start justify-between">
                        <div>
                          <h3 className="text-lg font-semibold text-gray-900 dark:text-white truncate">
                            {item.listing?.title || 'Sold Item'}
                          </h3>
                          <p className="text-sm text-gray-600 dark:text-gray-400 mt-1">
                            Original Price: €{item.listing?.price?.toFixed(2) || '0.00'}
                          </p>
                          {/* Buyer Information */}
                          {item.buyer && (
                            <div className="mt-2 flex items-center space-x-2">
                              <span className="text-xs text-gray-500 dark:text-gray-500">Buyer:</span>
                              <div className="flex items-center space-x-1">
                                {item.buyer.is_business && (
                                  <span className="inline-flex items-center px-1.5 py-0.5 rounded text-xs font-medium bg-blue-100 text-blue-800 dark:bg-blue-900/30 dark:text-blue-300">
                                    Business
                                  </span>
                                )}
                                <span className="text-sm font-medium text-gray-900 dark:text-white">
                                  {item.buyer.business_name || item.buyer.full_name || item.buyer.username}
                                </span>
                              </div>
                            </div>
                          )}
                      ...
                      <div className="mt-4 flex items-center justify-between">
                        <div className="flex items-center space-x-4">
                          <div className="text-center">
                            <p className="text-sm text-gray-600 dark:text-gray-400">Sold Price</p>
                            <p className="text-xl font-bold text-green-600 dark:text-green-400">
                              €{item.final_price?.toFixed(2) || item.listing?.price?.toFixed(2) || '0.00'}
                            </p>
                          </div>
                          
                          <div className="text-center">
                            <p className="text-sm text-gray-600 dark:text-gray-400">Sold Date</p>
                            <p className="text-sm font-medium text-gray-900 dark:text-white">
                              {item.sold_at ? new Date(item.sold_at).toLocaleDateString() : 'N/A'}
                            </p>
                          </div>
                        </div>
