...
REACT_APP_BACKEND_URL=https://admin-rebuild.preview.emergentagent.com
...
- ❌ Hardcoding `https://admin-rebuild.preview.emergentagent.com/api/uploads/`
...
- Backend URL: `https://admin-rebuild.preview.emergentagent.com` (as configured in frontend/.env)
...
- Using `https://admin-rebuild.preview.emergentagent.com/api/uploads/` directly in code
